...
.data
	...
	szaText	db 13,13,13,13
				...
				db "[ Target : LightPad 4.6.164 <SR1> . ]",13
				db "[ Date       : 11.1o.2o22 ......... ]",13
				db "[ Protection : RSA-370 + BASE-64 .. ]",8
				db 13,13,13,13
				db "[ 10x go 2 : ...................... ]",8
				db 13,13,13
				db "[ Mixer 4 CooL Music .............. ]",13
...
LOCAL rect:RECT
	...
	.if eax == WM_INITDIALOG
		...
		invoke SetWindowPos, yWnd, 0, ex, why, aWidth, aHeight, SWP_SHOWWINDOW
