...
Logfont		LOGFONTA <0> ;LOGFONT <190h,0FFFFFFF4h,0,0,FW_DONTCARE,0,0,0,DEFAULT_CHARSET,OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,\
									;DEFAULT_QUALITY	,0,'Lucida Console'>
ScrollFont		db	"Verdana",0
ScrollText	    		db	"MetaProducts LightPad 4.6.164 [SR1] - *kEyGeN.OnLy* :: "
						db  "protection : RSA-370 :: algo and gfx by r0ger :: msx by mixer :: "
						db  "sPecial gr33tZ to all PRF memberz and to all tSRh , TrainingCircle , "
						db  " exetools and Tuts4you forums , plus Intel Core 2 Extreme, Xylitol, Cachito, "
						db  "Talers, Jowy, Dilik, Vad1m, kEy-tONe, Bang1338, Log0 and many many other ppl,see ya! ;)",0
...
ScrollerInit proc hWnd:HWND
	...
	m2m scr.scroll_hwnd,hWnd
		...
		mov scr.scroll_x,1
		mov scr.scroll_y,266
		
		mov scr.scroll_width,381
		
		mov Logfont.lfHeight,0FFFFFFF6h
	    mov Logfont.lfQuality,2
	    push 8
		push offset ScrollFont ; "Lucida Console"
		push offset Logfont.lfFaceName
		call RtlMoveMemory
		push 190h
		pop Logfont.lfWeight
		push offset Logfont
